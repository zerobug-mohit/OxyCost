  ...
  return (
    <div className="methodology" data-no-i18n>
      <p className="doc-lead">
        ...
        दोनों टूल में <em>साझा</em> हैं — इकाइयाँ, ज़रूरत, और हर स्रोत की लागत — फिर दिखाता है कि{' '}
      ...
      <Section n="1" icon="📏" title="इकाइयाँ और रूपांतरण" open>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td>मीट्रिक टन (ज़रूरत)</td><td>cu m</td><td><code>1 MT = 750 cu m</code></td></tr>
          </tbody>
        </table>
      </Section>
      ...
      {/* ================================================================ */}
      <GroupHeading step="साझा" title="कितनी ऑक्सीजन चाहिए, यह निकालना" sub="वही गणित facility के स्टेप 1 और प्लानर के स्टेप 1 — दोनों को चलाता है।" />

      <Section n="3" icon="🩺" title="ज़रूरत निकालना">
        <p>
          ज़रूरत एक WJCF वर्कबुक से आती है। इसे मीट्रिक टन (MT) में नापा जाता है; 1 MT = 750 cu m।
        </p>
        ...
        <p>
          ...
          की ज़रूरत = <code>महीने की भर्ती × वह आँकड़ा</code>। facility टैब का <strong>भर्ती से</strong> विकल्प
          इसे सीधे इस्तेमाल करता है। <strong>प्लानर का स्टेप 1</strong> आपके चुने राज्य या ज़िले की हर facility
          की तय ज़रूरत जोड़ देता है, और आप इसे हर facility तक खोल सकते हैं। सिर्फ़ मिले-जुले कुल और
      ...
      <Section n="9" icon="⚖️" title="तुलना को जोड़ना">
        ...
        <DocCards cols={3}>
          ...
          <DocCard icon="🎯" title="सप्लाई जाँचता है">
            coverage पट्टी जोड़ती है कि हर स्रोत कितना दे सकता है और उसे स्टेप 1 की ज़रूरत से मिलाती है (करीब
      ...
      <Section n="10" icon="📊" title="चार्ट पढ़ना">
        <DocCards cols={3}>
          <DocCard icon="📉" title="लागत बनाम कितना इस्तेमाल">
            ...
            होगी। जहाँ रेखाएँ मिलती हैं, वहीं सस्ता स्रोत बदलता है। डैश वाली रेखा आपकी ज़रूरत है; कोई रेखा उस
      ...
      <Section n="11" icon="🗺️" title="बजट कैसे बनता है" id="state">
        <p>
          स्टेप 1 के ज़रूरत निकालने (§3b) के बाद, स्टेप 2 बजट बनाता है। आप या तो बताते हैं कि हर{' '}
          ...
          डेटा से बनता है — यह आकार पर निर्भर करता है, और स्टेप 1 में चुना राज्य / ज़िला <em>ज़रूरत</em> तय
        ...
        <p>
          ...
          की गई facilities</strong> को देखता है और उनमें जो आम है वह ले लेता है — तीन स्टेपों में:
        </p>
        <FlowSteps
          steps={[
      ...
      <Section n="12" icon="🧮" title="बजट जोड़ना और सप्लाई जाँचना">
        ...
        <p>
          <strong>coverage पट्टी</strong> इलाके की ज़रूरत (स्टेप 1) की तुलना उस ऑक्सीजन से करती है जो वही
      ...
      <Section n="14" icon="⚠️" title="मान्यताएँ, डेटा और निजता">
        <ul>
          ...
          <li>लागत-बनाम-इस्तेमाल चार्ट मानता है कि एक स्रोत दी गई मात्रा तक बढ़ सकता है; असल में facilities मिश्रण इस्तेमाल करती हैं। बहुत ज़्यादा ज़रूरत पर असल इस्तेमाल मान से ज़्यादा हो सकता है, इसलिए वे आँकड़े मोटे-मोटे हैं। क्रॉसओवर को निर्देश नहीं, मार्गदर्शन मानें।</li>
